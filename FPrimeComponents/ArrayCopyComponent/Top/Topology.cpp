...
Ref::ArrSenderComponentImpl arrSender(FW_OPTIONAL_NAME("arrSender"));
Ref::ArrReceiverComponentImpl arrReceiver(FW_OPTIONAL_NAME("arrReceiver"));
...
bool constructApp(bool dump, U32 port_number, char* hostname) {
    ...
    arrSender.init(1000,0);
    arrReceiver.init(1000,0);
    ...
    arrSender.regCommands();
    arrReceiver.regCommands();
