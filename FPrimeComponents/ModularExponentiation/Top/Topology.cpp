...
Ref::ExpSenderComponentImpl expSender(FW_OPTIONAL_NAME("expSender"));
Ref::ExpReceiverComponentImpl expReceiver(FW_OPTIONAL_NAME("expReceiver"));
...
bool constructApp(bool dump, U32 port_number, char* hostname) {
	...
	expSender.regCommands();
    expReceiver.regCommands();
    // read parameters
    prmDb.readParamFile();
